...
*/
	...
	var arr = [1, true, 'karina'];
	console.log( arr.toString() );

	console.log( 'O array em formato de string é:', arr );
...
*/
	...
	var sudeste = ['Espiríto Santo', 'Minas Gerais', 'Rio de Janeiro', 'São Paulo']
	var sul = ['Paraná', 'Floripa', 'Rio Grande do Sul']
	...
	*/
	var nordeste = ['Alagoas', 'Bahia', 'Ceará', 'Maranhão', 'Paraíba', 'Pernanbuco', 'Piauí', 'Rio Grande do Norte', 'Sergipe'];
