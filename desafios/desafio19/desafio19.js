...
function temClasse(markup, classe) {
	var regex = new RegExp('class=[\'\"].?' + classe + '.*?[\'\"]');
	return regex.test(markup) + ' para a classe ' + classe;
}

console.log( temClasse(markup, "container") );
console.log( temClasse(markup, "text") );
console.log( temClasse(markup, "date") );
console.log( temClasse(markup, "excerpt") );
console.log( temClasse(markup, "main") );
